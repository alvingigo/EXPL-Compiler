...
#line 24 "exptree.y"
    ...
    int r=codeGen((yyvsp[(1) - (2)].no));
    printf("%d\n",evaluate((yyvsp[(1) - (2)].no)));
    print(r);
    postfix((yyvsp[(1) - (2)].no));
    printf("\n");
    prefix((yyvsp[(1) - (2)].no));
  ...
  case 3:
#line 37 "exptree.y"
    {(yyval.no) = makeOperatorNode('+',(yyvsp[(2) - (3)].no),(yyvsp[(3) - (3)].no));}
    break;
